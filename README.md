...
- Supports Mewgenics `1.1.b21039`, the earlier `1.1.b21220` beta, and current Steam beta build `25108421`, with build-specific signature validation before native hooks are installed.
...
- 支持 Mewgenics `1.1.b21039` 正式版、此前的 `1.1.b21220` beta，以及当前 Steam beta build `25108421`；安装原生钩子前会先验证对应版本签名。
