...
- Supports Mewgenics `1.1.b21039`, the earlier `1.1.b21220` beta, and Steam beta builds `25108421` and `25131239`, with build-specific signature validation before native hooks are installed.
...
- 支持 Mewgenics `1.1.b21039` 正式版、此前的 `1.1.b21220` beta，以及 Steam beta build `25108421`、`25131239`；安装原生钩子前会先验证对应版本签名。
